...
function test(){
	...
	//$.ajax({
		//type:"GET",
		//url:"http://localhost:8080/StudentCourseRegistrationSystem/rest/login/dologin?username="+username+"&password="+hash,
		//dataType:"json",
	
	//$.ajax({
		//type:"GET",
		//url:"https://localhost:8443/StudentCourseRegistrationSystem/rest/login/dologin?username="+username+"&password="+password,
		//dataType:"json",
		//async:false,
